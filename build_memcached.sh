...
gzip -c /tmp/test.txt | curl -v -X POST --data-binary @- -H "Content-Encoding: gzip" -u ${BASIC_USER}:${BASIC_PASSWORD} https://${RENDER_EXTERNAL_HOSTNAME}/auth/test20240126.php
