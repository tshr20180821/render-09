...
socat -d -4 tcp-listen:3632,bind=127.0.0.1,reuseaddr,fork "exec:curl -NsS http\://${PIPING_SERVER}/${KEYWORD}distccd_response!!exec:curl -NsST - http\://${PIPING_SERVER}/${KEYWORD}distccd_request" &
