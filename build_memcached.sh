...
socat -ddd tcp-listen:3632,reuseaddr,fork,sndbuf=81920 "exec:curl -v -u ${BASIC_USER}\:${BASIC_PASSWORD} --stderr /var/www/html/auth/strerr.txt --data-binary @- https\://${RENDER_EXTERNAL_HOSTNAME}/auth/distccd.php" &
