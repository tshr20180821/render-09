...
socat -x -ddd -4 tcp-listen:3632,bind=127.0.0.1,reuseaddr,fork 'system:"stdbuf -o0 recode ../b64 | socat -tcp:127.0.0.1:9001"' &
socat -4 tcp-listen:9001,bind=127.0.0.1,reuseaddr,fork "exec:./piping-duplex ${KEYWORD}distccd_response ${KEYWORD}distccd_request" &
