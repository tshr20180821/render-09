...
socat -ddd tcp-listen:3632,reuseaddr,fork "exec:curl -u ${BASIC_USER}\:${BASIC_PASSWORD} --stderr /var/www/html/auth/strerr.txt -T - https\://${RENDER_EXTERNAL_HOSTNAME}/auth/distccd.php" &
