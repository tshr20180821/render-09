...
ncat --sh-exec "ncat -u 127.0.0.1 3632" -4nkl 3632 -s 127.0.0.1 --no-shutdown --allow 127.0.0.1 &
ncat --sh-exec "/usr/src/app/distccd_wrapper.sh" -4ukl 3632 -s 127.0.0.1 --no-shutdown --allow 127.0.0.1 &
